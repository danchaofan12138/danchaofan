...
功能:签到，积分兑换礼物
支持:QX 青龙 V2P 
本地重写:/online/capi/uc/getCount url script-request-header tmkk.js
hostname = apis.folidaymall.com
青龙抓包:https://apis.folidaymall.com/online/capi/uc/getCount,请求头Authorization的全部内容。变量名称:tmkkAuthorization
*/
const jsname = '托迈酷客'
const $ = new Env(jsname);
let logDebug = 0
LBJSNAMED = $.isNode() ? require("path").basename(__filename) : `tmkk.js`
...
let cxurl = 'online/capi/uc/getCount'
let host = 'https://apis.folidaymall.com/'
...
//签到
ret = await userList[i].LB_GET(`online/cms-api/sign/userSign`)

if (ret.data.signInfo.signInStatus == 0) {
console.log(`账号【${index}】签到成功，${ret.data.signInfo.msg}\n 已连续签到${ret.data.signInfo.continousSignDays}天\n 已有积分共${ret.data.signInfo.currentIntegral}分`);
                } else if (ret.data.signInfo.signInStatus == 1){
console.log(`账号【${index}】已签到！明天再来吧\n 已连续签到${ret.data.signInfo.continousSignDays}天\n 已有积分共${ret.data.signInfo.currentIntegral}分`);
                }
