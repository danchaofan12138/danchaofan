...
小程序:贝好多农场
支持:QX、V2P、青龙
给小鸡喂食下鸡蛋，鸡蛋兑换商品，之前有100个鸡蛋兑换的，现在只有400了。挂青龙吧，我之前兑换100鸡蛋是正常到的。
...
let Change = "支持QX、V2P、青龙 修复喂小鸡问题";
//let thank = `\n感谢 蛋炒饭大佬的脚本\n`;
//---------------------------------------------------------------------------------------------------------
...
'Accept-Encoding' : `gzip,compress,br,deflate`
	...
	let result = await PublicRequests('get', Options);
	if (result.errcode == 0) {
		DoubleLog(`日签成功:获得 ${result.data.feed}g粮食🌾`);
		//await wait(3);
	} else {
		DoubleLog(`日签失败: 失败 ❌ 了呢,原因未知!`);
		console.log(result);
	}
}
...
'Accept-Encoding' : `gzip,compress,br,deflate`
	...
	let result = await PublicRequests('get', Options);
	if (result.errcode == 0) {
		DoubleLog(`观看成功:获得 ${result.data.feed}g粮食🌾`);
		//await wait(3);
	} else {
		DoubleLog(`观看失败: 失败 ❌ 了呢,原因未知!`);
		console.log(result);
	}
}
...
'Accept-Encoding' : `gzip,compress,br,deflate`
	...
	let result = await PublicRequests('get', Options);
	if (result.errcode == 0) {
		DoubleLog(`查看成功:获得 ${result.data.feed}g粮食🌾`);
		//await wait(3);
	} else {
		DoubleLog(`查看失败: 失败 ❌ 了呢,原因未知!`);
		console.log(result);
	}
}
...
//每日答题
async function bhdmrdt() {
	let Options = {
		url: `https://farm.weiyanwy.com/server/Task/answerQuestion?jwt=${ck[0]}&item_id=48&answer=2`,
		headers: {
	'Referer' : `https://servicewechat.com/wxa537746dcd832b1c/1/page-frame.html`,
'Connection' : `keep-alive`,
'Host' : `farm.weiyanwy.com`,
...
'Accept-Encoding' : `gzip,compress,br,deflate`
	...
	let result = await PublicRequests('get', Options);
	if (result.errcode == 0) {
		DoubleLog(`答题成功，共10题，已完成${result.data.finish}题🌾`);
		//await wait(3);
	} else {
		DoubleLog(`答题失败: 失败 ❌ 了呢,原因未知!`);
		console.log(result);
	}
}
async function bhdmrdtlq() {
	let Options = {
		url: `https://farm.weiyanwy.com/server/Task/drawFeed?jwt=${ck[0]}&type=5&is_video=1`,
		headers: {
	'Referer' : `https://servicewechat.com/wxa537746dcd832b1c/1/page-frame.html`,
'Connection' : `keep-alive`,
'Host' : `farm.weiyanwy.com`,
...
'Accept-Encoding' : `gzip,compress,br,deflate`
	...
	let result = await PublicRequests('get', Options);
	if (result.errcode == 0) {
		DoubleLog(`你真善良:获得 ${result.data.feed}g粮食🌾`);
		//await wait(3);
	} else {
		DoubleLog(`你不善良: 失败 ❌ 了呢,原因未知!`);
		console.log(result);
	}
}
...
'Accept-Encoding' : `gzip,compress,br,deflate`
	...
	let result = await PublicRequests('get', Options);
	if (result.errcode == 0) {
		DoubleLog(`加餐成功:获得 ${result.data.feed}g粮食🌾`);
		//await wait(3);
	} else {
		DoubleLog(`加餐失败: 失败 ❌ 了呢,原因未知!`);
		console.log(result);
	}
}
...
'Accept-Encoding' : `gzip,compress,br,deflate`
	...
	let result = await PublicRequests('get', Options);
	if (result.errcode == 0) {
		DoubleLog(`连续签到成功:获得 ${result.data.feed}g粮食🌾`);
		//await wait(3);
	} else {
		DoubleLog(`连续签到失败: 失败 ❌ 了呢,原因未知!`);
		console.log(result);
	}
}
...
'Accept-Encoding' : `gzip,compress,br,deflate`
	...
	let result = await PublicRequests('get', Options);
	if (result.errcode == 0) {
		DoubleLog(`哇，5000步成功:获得 ${result.data.feed}g粮食🌾`);
		//await wait(3);
	} else {
		DoubleLog(`步数不够: 失败 ❌ 了呢,原因未知!`);
		console.log(result);
	}
}
...
'Accept-Encoding' : `gzip,compress,br,deflate`
	...
	let result = await PublicRequests('get', Options);
	if (result.errcode == 0) {
		DoubleLog(`晒蛋成功:获得 ${result.data.feed}g粮食🌾`);
		//await wait(3);
	} else {
		DoubleLog(`晒蛋: 失败 ❌ 了呢,原因未知!`);
		console.log(result);
	}
}
...
'Accept-Encoding' : `gzip,compress,br,deflate`
	...
	let result = await PublicRequests('get', Options);
	if (result.errcode == 0) {
		DoubleLog(`赠送鸡蛋:获得 ${result.data.feed}g粮食🌾`);
		//await wait(3);
	} else {
		DoubleLog(`赠送失败: 失败 ❌ 了呢,原因未知!`);
		console.log(result);
	}
}
...
//刷新饭盆
async function bhdsx() {
	let Options = {
		url: `https://farm.weiyanwy.com/server/Index/getUserInfo?jwt=${ck[0]}`,
		headers: {
	'Referer' : `https://servicewechat.com/wxa537746dcd832b1c/1/page-frame.html`,
'Connection' : `keep-alive`,
'Host' : `farm.weiyanwy.com`,
